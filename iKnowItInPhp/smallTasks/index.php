    ...
    <ul>
        <?php
            $bookLists= [
                ...
                ['titleA'=>'Sort numeric table', 'describeA'=>'In this exercise We sort table from smallest to bigest value numeric: array = [14, 10, 22, 3, "mata", 4, "lala",5, 6, 7, boolean, 9, 7, 0]. Next will by check for not reapiting number.', 'fileA'=>'sortNumericValue'],
